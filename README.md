...
This script helps you install [Pi-hole](https://github.com/pi-hole/pi-hole) with an admin web interface, several security options and adds a huge number of frequently updated hosts/domains to the Pi-hole blacklist. All this with minimal user interaction.
